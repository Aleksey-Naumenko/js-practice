...
successRequest
    ...
    .catch(function onError1(error) {     // has to execute with 'Error with data'
...
failRequest
    ...
    .then(function onSuccess2(data) {  // not to execute
        console.log("onSuccess2", data);
    })
    .catch(function onError3(error) {    // has to execute with 'Server error'
